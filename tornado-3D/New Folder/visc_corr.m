...
for i=1:geo.nwing
    ...
    for j=n1:n2
        x(1,j)=lattice.VORTEX(j,2,1);
        x(2,j)=lattice.VORTEX(j,3,1);

        y(1,j)=lattice.VORTEX(j,2,2);
        y(2,j)=lattice.VORTEX(j,3,2);

        z(1,j)=lattice.VORTEX(j,2,3);
        z(2,j)=lattice.VORTEX(j,3,3);
    end
